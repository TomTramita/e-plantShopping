...
function ProductList() {
  ...
  const [showPlants, setShowPlants] = useState(true); // State to control the visibility of the plant listing
  ...
  const handleCartClick = (e) => {
    ...
    setShowPlants(false); // Hide the plant listing
  };

  // Handle plants link click
  ...
  return (
    <div>
      ...
      <div className="navbar">
        ...
        <div class="ul">
          <div>
            <a className="a" href="#" onClick={(e) => handlePlantsClick(e)} >
              Plants
            </a>
          </div>
          <div>
            <a className="a" href="#" onClick={(e) => handleCartClick(e)} >
              <h1 className="cart">
                <svg
